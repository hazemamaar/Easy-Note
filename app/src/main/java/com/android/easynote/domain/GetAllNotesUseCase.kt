...
import com.android.easynote.core.helpers.SortNotes
import com.android.easynote.data.Repo.LocalRepo
import com.android.easynote.data.entities.NoteDto
import kotlinx.coroutines.flow.Flow
import kotlinx.coroutines.flow.flow

class GetAllNotesUseCase(private val localRepo: LocalRepo,private val sortNotes: AndroidSortNotes):BaseLocalUseCase<List<NoteDto>,List<NoteDto>,Any>() {
...
//    }
    ...
    override suspend fun run(params: Any?): Flow<List<NoteDto>> = flow {
        ...
        emit(sortNotes.sortNotesByPin(localRepo.getAllNotes()))
    }
